...
/**
 * A {@link PollManager PollManager} that hands over the actual handling of polling events to an external script.
 * <p/>
 * The scripts are executed by invoking <tt>System.execute()</tt> with a given shell command.
 * <p/>
 * By default, win32 invocation uses <tt>%COMMSPEC%</tt> and Unix invocation uses <tt>/bin/sh</tt>.
 *
 * @author cris
 * @version 1.0
 */

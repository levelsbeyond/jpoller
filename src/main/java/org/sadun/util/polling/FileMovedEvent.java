...
/**
 * Indicates that the poller has performed an automatic move of a polled file. Can be signalled only if the autoMove
 * move is active (see {@link DirectoryPoller DirectoryPoller class description}).
 *
 * @author C. Sadun
 * @version 1.0
 */
public class FileMovedEvent extends BasePollerEvent {
	...
	/**
	 * Return the new path of the file. Since the file has been moved, this File object corresponds to the physical file on
	 * the filesystem.
	 *
	...
	/**
	 * Return a {@link MovedFile MovedFile} object encapsulating the move operation.
	 *
	 * @return a {@link MovedFile MovedFile} object encapsulating the move operation.
	 */

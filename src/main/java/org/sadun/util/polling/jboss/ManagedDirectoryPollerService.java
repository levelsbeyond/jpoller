...
/**
 * An extension to the {@link org.sadun.util.polling.ManagedDirectoryPoller ManagedDirectoryPoller} mbean implementation
 * which exposes JBoss' service interface.
 *
 * @author cris
 */

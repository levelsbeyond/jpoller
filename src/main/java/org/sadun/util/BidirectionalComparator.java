...
public abstract class BidirectionalComparator implements Comparator {
	...
	/**
	 * Expects the two objects to be of File class and returns the ordering indicator based on the direction specified at
	 * construction
	 */
	 ...
	 *
	 * @return the comparation value (0, greater than 0 or lower than 0) for the two files.
	 */
